...
#配置国内软件源
echo "deb https://mirrors.ustc.edu.cn/ubuntu-ports/ noble main restricted universe multiverse
...
deb https://mirrors.ustc.edu.cn/ubuntu-ports/ noble-backports main restricted universe multiverse" >/etc/apt/sources.list
